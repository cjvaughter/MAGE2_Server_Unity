...
public static class Constants
{
    ...
    public const string Coordinator_VID = "0403";
    public const string Coordinator_PID = "6001";
    public const string Coordinator_SN = "M2-COORD";

    public const string PIU_VID = "0403";
    public const string PIU_PID = "6015";
    public const string PIU_SN = "M2-PIU";

    public const string ServerUpdateURL = "https://api.github.com/repos/cjvaughter/mageboot/contents/release";
    public const string PIUUpdateURL = "https://api.github.com/repos/cjvaughter/mageboot/contents/release";
    public const string NamePattern = "\"name\": \"(.+?)";
    public const string URLPattern = "\"download_url\": \"(.+?)";
